        ...
        <div className="flex justify-between items-center py-4">
          ...
          <div className="flex-shrink-0">
            <Link href="/" className="flex items-center">
              <div className="bg-primary-600 text-white px-4 py-2 rounded-lg font-heading font-bold text-xl">
                SH
              </div>
              <span className="ml-3 text-2xl font-heading font-bold text-gray-900">
                Senjin Holdings
              </span>
            </Link>
          </div>
